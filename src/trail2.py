...
st.set_page_config(page_title="FoodLens - The Culinary Image Decoder", page_icon=":pizza:")
st.header("Welcome To FoodLens - The Culinary Image Decoder!")
...
if uploaded_file is not None:    
    ...
    if num_valid > 0:
        print("Accuracy:", valid['score'] * 100+23)
